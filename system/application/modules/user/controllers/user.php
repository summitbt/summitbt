...
class User extends Template_Controller {
...
//
//		// Get pages records
//		$segmented = $this->issues_m->get_segmented($page, $count);
//
//		// Pagination
...
//		}
		...
		// Build the page
		$this->build('user/user', $title, $data, $breadcrumbs);
	}
